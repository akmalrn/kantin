<!-- resources/views/User/ReadData/HalamanBarangPenjual.blade.php -->
...
<head>
    ...
    <title>Daftar Barang Penjual</title>
    <style>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('HalamanUbahBarang', ['id' => $barang->id]) }}" style="display: inline-block;" class="ubah">Ubah</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
